...
########################################
#make sure we have pictures directory
#######################################
...
######################################
#Summarize and report what we have in the pictures directory
#######################################
...
#make a report on what we have in the pitcutre directory
